...
var ViaSlide = angular.module('ViaSlide', ['ngCookies','angularFileUpload', 'ui.router', 'ngProgress']);
...
ViaSlide.controller('ViaSlideCtrl', function ($rootScope, $state, $scope, USER_ROLES, AuthService, Session, AUTH_EVENTS, $window, ngProgress, $cookieStore){
	var credentials = {
...
ViaSlide.run(function ($rootScope, $state, AUTH_EVENTS, AuthService, Session, ngProgress, $location){
...
ViaSlide.config(function ($httpProvider, $locationProvider) {
...
ViaSlide.factory('AuthInterceptor', function ($rootScope, $q, AUTH_EVENTS) {
  return {
